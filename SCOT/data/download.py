...
def load_dataset(benchmark, datapath, thres, device, split='test', cam='', ann_dir='', img_dir='', drone_dir=''):
    ...
    return dataset(benchmark, datapath, thres, device, split, cam, ann_dir, img_dir, drone_dir)
